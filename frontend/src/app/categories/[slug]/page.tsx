...
import { ArrowLeft, ArrowRight, Grid, List } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 pb-12 bg-gradient-to-b from-primary/10 to-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/categories" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary mb-6">
          ...
          >
            {category?.image_data && (
              <div className="w-20 h-20 rounded-2xl overflow-hidden mb-4 bg-secondary">
                <img
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              {category?.description || `Explore our collection of ${slug.replace(/-/g, ' ')} products`}
            </p>
          </motion.div>
        </div>
      </section>
